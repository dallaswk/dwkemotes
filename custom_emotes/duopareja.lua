...
addPair("couple85f", "smo@couple_85", "f_couple_85_clip", "couple85m", "smo@couple_85", "m_couple_85_clip", "Couple Pose 85 (Smos)", 0.02, 0.28, 0.00, 0.00, nil, nil, nil, nil, true)
...
addPair("couple87f", "smo@couple_87", "f_couple_87_clip", "couple87m", "smo@couple_87", "m_couple_87_clip", "Couple Pose 87 (Smos)", 0.08, 0.00, 0.00, 180.00, nil, nil, nil, nil, true)
...
addPair("couple89f", "smo@couple_89", "f_couple_89_clip", "couple89m", "smo@couple_89", "m_couple_89_clip", "Couple Pose 89 (Smos)", 0.05, 0.00, 0.00, 0.00, nil, nil, nil, nil, true)
...
addPair("couple115a", "smo@couple_115", "couple_115_a_clip", "couple115b", "smo@couple_115", "couple_115_b_clip", "Couple Pose 115 (Smos)", 0.08, 0.18, 0.00, 180.00, nil, nil, nil, nil, true)
...
addPair("couple120a", "smo@couple_120", "couple_120_a_clip", "couple120b", "smo@couple_120", "couple_120_b_clip", "Couple Pose 120 (Smos)", 0.02, 0.00, 0.00, 180.00, nil, nil, nil, nil, true)
...
addPair("couple123a", "smo@couple_123", "couple_123_a_clip", "couple123b", "smo@couple_123", "couple_123_b_clip", "Couple Pose 123 (Smos)", 0.05, 0.00, 0.00, 180.00, nil, nil, nil, nil, true)
...
addPair("couple127a", "smo@couple_127", "couple_127_a_clip", "couple127b", "smo@couple_127", "couple_127_b_clip", "Couple Pose 127 (Smos)", 0.00, 0.00, 0.00, 180.00, nil, nil, nil, nil, true)
addPair("couple128a", "smo@couple_128", "couple_128_a_clip", "couple128b", "smo@couple_128", "couple_128_b_clip", "Couple Pose 128 (Smos)", 0.05, 0.00, 0.00, 180.00, nil, nil, nil, nil, true)
addPair("couple129a", "smo@couple_129", "couple_129_a_clip", "couple129b", "smo@couple_129", "couple_129_b_clip", "Couple Pose 129 (Smos)", 0.05, 0.00, 0.00, 180.00, nil, nil, nil, nil, true)
addPair("couple130a", "smo@couple_130", "couple_130_a_clip", "couple130b", "smo@couple_130", "couple_130_b_clip", "Couple Pose 130 (Smos)", 0.00, 0.25, 0.00, 0.00, nil, nil, nil, nil, true)
...
addPair("couple132a", "smo@couple_132", "couple_132_a_clip", "couple132b", "smo@couple_132", "couple_132_b_clip", "Couple Pose 132 (Smos)", 0.00, 0.00, 0.00, 180.00, nil, nil, nil, nil, true)
...
addPair("ffriend12a", "smo@friend_female_12", "f_friend_12_a_clip", "ffriend12b", "smo@friend_female_12", "f_friend_12_b_clip", "Friend Pose 12 (Smos)", 0.00, 0.28, 0.00, 0.00, nil, nil, nil, nil, true)
...
addPair("perlenfuchs_couple7_f", "perlenfuchs@couple7_f", "couple7_f_clip", "perlenfuchs_couple7_m", "perlenfuchs@couple7_m", "couple7_m_clip", "Perlenfuchs Couple 7", 0.05, 0.00, 0.00, 180.00, nil, nil, nil, nil, true)
